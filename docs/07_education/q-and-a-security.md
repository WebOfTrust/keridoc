...
By a key [`inception event`](https://weboftrust.github.io/WOT-terms/docs/glossary/inception-event). A controller creates a key pair and binds this to his/her KERI identifier.
